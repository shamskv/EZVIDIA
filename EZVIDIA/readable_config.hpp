...
extern std::string confName;
extern std::atomic<bool> configLock;	//For the 5s delay
extern std::mutex confMutex;			//For writing/deleting configs
extern std::vector<GlobalConfig> configList;
