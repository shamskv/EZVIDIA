...
LRESULT SaveConfDialog::callbackProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
...
LRESULT SaveConfDialog::handleCommand(HWND hDlg, WPARAM wParam, WindowsGui* thisPtr) {
...
INT_PTR SaveConfDialog::show(HINSTANCE hInst, HWND hWnd, LPARAM lParam) {
	return DialogBoxParam(hInst, MAKEINTRESOURCE(IDD_DIALOG1), hWnd, callbackProc, lParam);
}