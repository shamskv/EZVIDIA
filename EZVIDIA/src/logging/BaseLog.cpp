#include "BaseLog.hpp"
// Include all the policies available, this is necessary to compile the template
// specializations at the end of the file
...
void getCurrentTimeStamp(char* buffer, size_t size) {
  ...
  sprintf_s(buffer, size, "%04u-%02u-%02u %02u:%02u:%02u:%03u", systime.wYear,
